							 	...
							 	for($i=0;$i<$count;$i++)
									{
										...
										if($query)
										{
												...
												$query=$this->db->query("UPDATE tbl_showroom_stock SET quantity=quantity-'$quantity' WHERE product_code='".$product_code[$i]."' AND showroom_id='".$showroom_id[$i]."'");
