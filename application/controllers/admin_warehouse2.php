...
class Admin_warehouse2 extends CI_Controller {
...
/**/
	...
	function update_warehouse2()
	{
			...
			$this->db->where('id',$id);
			$query=$this->db->update('tbl_warehouse2',$data) or die(mysql_error());
			if($query)
			{
