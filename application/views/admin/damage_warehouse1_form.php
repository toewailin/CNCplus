 ...
 <h1 > <small>Main Warehouse Reject Entry Form</small></h1>

<?=form_open("",'class="cloneable-form" id="damage_warehouse1"');?>
<?=form_hidden("user",get_cookie("admin_cookie"));?>
 ...
 <div class="container">
        ...
        <th class="center"><?=$quantity?> (Pcs)</th>
                ...
                <tr class="clonethis">
                   <td ><?=form_input('product_code[]','','class="form-control-discount autocomplete"  onkeyup="fillWithPurchase(this.value,event,\'warehouse1\')"  autocomplete="off"');?> <div class="display"></div></td>
                  ...
                  <tr>
                    ...
                    <td align="right" colspan="5"><?php echo form_button('save',$save,'class="btn btn-primary btn-lgy" onclick="insert_form(\'damage_warehouse1\')"');?></td>
                </tr> 
