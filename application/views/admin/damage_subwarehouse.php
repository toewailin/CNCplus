            ...
            <div class="panel panel-primary">
              <div class="panel-heading heading-over">
               ...
               <div class="container">
                    ...
                    <div class="col-md-3">
                  <h3 class="panel-title"><i class="fa fa-bars"></i> Sub-Warehouse Reject Lists</h3>
                  </div>

                  <div class="col-md-8">
                     <form name="singlesearch" id="damage_subwarehouse">
                 <?=$from?> <input type="text" name="startdate" class="form-control-sale date" id="date1"/>
                  ...
                  Colunm <select name="colunm" class="form-control-sale" >
                    <option value="subwarehouse_id">Sub-Warehouse Name</option>
               ...
               Value <input type="text" name="search" class="form-control-sale" onkeyup="searchsingle('damage_subwarehouse')"/>
          
              <input type="button" class="btn btn-primary active" value="<?=$search?>" onclick="searchsingle('damage_subwarehouse')">
            ...
            <div class="col-md-1 text-right"> 
                  ...
                  <?=anchor("admin/insert_form/damage_subwarehouse_form",$addnew,'class="btn btn-default active"')?>
