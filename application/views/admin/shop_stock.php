            ...
            -->
             ...
             <input type="button" class="btn btn-default active" value="<?=$search?>" onclick="searchsingle('shop_stock')">
                  ...
                  <div class="col-md-2 text-right"> 
                     <a href="javascript:show_form('shop_stock_form')" class="btn btn-default active">Add New</a> 
              ...
              <?php 
               foreach($categories->result() as $category):
                          ...
                          ?>           
                  <li class="">
                     <?=anchor("admin/data_list/shop_stock/".$category->category,'<i class="fa fa-"></i><span>'.$category->category.'</span>')?>
                  </li>
                  <?php endforeach ?>
