              ...
              <div class="panel-heading heading-over">
                  ...
                  <div class="container"> 
                      ...
                      <div class="col-lg-2 col-md-2">  
                        ...
                        <h3 class="panel-title"><i class="fa fa-bars"></i> Purchase Delivery List</h3>
                      </div>
   ...
   <?=$from?> <input type="text" name="startdate" class="form-control-sale date " id="date1"/>
                  ...
                  <table class="table table-bordered table-hover table-striped tablesorter">
                    <thead class="thead-over">
                      <tr>
                        ...
                        <th width="130">Order Voucher No</th>
              ...
              foreach($lists->result() as $list):
                     ...
                     ?>
                      ...
                      <td width="60"><?=$count?></td>
                       ...
                       <td width="100"><?=$list->advance?></td>
                          ...
                          <td  width="200"><?=$list->order_voucherno?></td>
                  ...
                  ?>
                  <tr>
                    <td align="right" colspan="4">All Total </td> <td> <?=number_format($total)?></td>
                    </tr>
                  </tbody>
                  </table>
