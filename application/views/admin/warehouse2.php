            ...
            <div class="panel panel-primary">
              ...
              <div class="container"> 
                  <div class="col-lg-3 col-md-3">  <h3 class="panel-title"><i class="fa fa-bars"></i> Warehouse (2) Stock Lists </h3></div>
                 
                  <div class="col-lg-8 col-md-8">  
                       <form name="singlesearch" id="warehouse2" class="searchform">
              ...
              Value <input type="text" name="search" class="form-control-sale" onkeyup="searchsingle('warehouse2')" />
              
             <!--  <input type="button" class="btn btn-primary" value="Search" onclick="searchsingle(document.singlesearch.data.value,document.singlesearch.colunm.value,'warehouse2')">
            -->
            
             <input type="button" class="btn btn-default active" value="<?=$search?>" onclick="searchsingle('warehouse2')">
                  ...
                  <div class="col-lg-1 col-md-1 text-right"> 
                   ...
                   <?=anchor("admin/insert_form/warehouse2_form",$addnew,'class="btn btn-default active"')?>
              ...
              <?php 
               foreach($categories->result() as $category):
                          ...
                          ?>           
                  <li class="">
                     <?=anchor("admin/data_list/warehouse2/".urlencode($category->category),'<i class="fa fa-"></i><span>'.$category->category.'</span>')?>
                  </li>
                  <?php endforeach ?>
                    ...
                    <thead  class="thead-over">
                      ...
                      <th>No</th>
                       ...
                       <!--  <th width="280"><?=$quantity?></th>
                        <th width="480"><?=$smallitemcount?></th>     -->                    
                        <th width=""><?=$price?></th>
                        <th> Total</th>
                        <th width="150">
            ...
            foreach($lists->result() as $list):
              $formid="form".$list->id;
                     ...
                     <td width="150">
                         ...
                         <a href="javascript:makeedit('<?=$list->id?>','warehouse2')"><?=$edit?></a> 
                                                      
                          / 
                     <a href="javascript:makedelete('<?=$list->id?>','warehouse2','<?=$this->uri->segment(4)?>')"><?=$delete?></a>
                        / 
            ...
            ?>
             <table class="table table-bordered table-hover table-striped tablesorter">
               <tr>
                <td> Warehouse</td>
              <td> 
                     <span><input type="text" name="warehouse" class="form-control" readonly='readonly' value="warehouse2" /></span>
</td>
               ...
               <tr>
                 ...
                 <?php echo form_button('save',$save,'class="btn btn-primary btn-lgy" onclick="stock_transfer(\'warehouse2\','.$list->id.')"');;?>
                 </td>
               </tr>
             </table>
             <?=form_close()?>
