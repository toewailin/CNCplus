 ...
 <h1 > <small>Consinement Reject Entry Form</small></h1>

<?=form_open("",'class="cloneable-form" id="damage_consinement"');?>
                ...
                <tr class="clonethis">
                   <td ><?=form_input('product_code[]','','class="form-control-discount autocomplete"  onkeyup="fill(this.value,event)" autocomplete="off"');?> <div class="display"></div></td>
                    ...
                    <td> <?=form_input('quantity[]','','class="form-control-discount qty" onkeyup="admincloneform(event)"');?></td>
                     <td width="100"> <?=form_dropdown('consinement_id',$grab_tbl_id,'','class="form-control-discount clonelastone" onkeyup="admincloneform(event)"');?></td> 
                  ...
                  <tr>
                    ...
                    <td align="right" colspan="5"><?php echo form_button('save',$save,'class="btn btn-primary btn-lgy" onclick="insert_form(\'damage_consinement\')"');?></td>
                </tr> 
