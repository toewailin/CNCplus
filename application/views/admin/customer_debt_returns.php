            ...
            <div class="panel panel-primary">
              ...
              <table class="table table-bordered table-hover table-striped tablesorter">
                    ...
                    $total=0;
                        ...
                        <td><?=$count?></td>
                         <td><?=$list->customer?></td>
                        <td id="exceed_amount<?=$list->id?>"><?php if($list->total_debt>0){echo number_format($list->total_debt);$debttype="debt_from_customer";}?></td>
                  ...
                  <?php $form=($this->uri->segment('3')=="debt_from_customer"? "debt_return_from_customer_form":"debt_return_to_supplier_form")?>
