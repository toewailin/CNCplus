            ...
            <div class="panel panel-primary">
              <div class="panel-heading heading-over">
               <div class="container">
                  ...
                  <div class="col-lg-2 col-md-2">
                    <h3 class="panel-title"><i class="fa fa-bars"></i> Sub-Warehouse Lists</h3>
                  </div>

                  <div class="col-lg-9 col-md-9">
                      <form name="getreport" id="subwarehouse">
             <?=$from?> <input type="text" name="startdate" class="form-control-sale date" id="date1"/>
              ...
              Value <input type="text" name="search" class="form-control-sale" onkeyup="searchsingle('subwarehouse')"/>
              
              <input type="button" class="btn btn-primary active" value="<?=$search?>" onclick="searchsingle('subwarehouse')">
            </form> 
                  </div>
                ...
                <div class="col-lg-1 col-md-1 text-right">  
                   ...
                   <a href="javascript:show_form('subwarehouse_form')" class="btn btn-default active"><?=$addnew?></a> 
