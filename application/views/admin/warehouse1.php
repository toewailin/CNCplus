            ...
            <div class="panel panel-primary">
              ...
              <div class="container"> 
                  <div class="col-lg-3 col-md-3">  <h3 class="panel-title"><i class="fa fa-bars"></i> Main Warehouse Stock Lists </h3></div>
            ...
            -->
             ...
             <input type="button" class="btn btn-default active" value="<?=$search?>" onclick="searchsingle('warehouse1')">
                  ...
                  <div class="col-lg-1 col-md-1 text-right"> 
                   ...
                   <?=anchor("admin/insert_form/warehouse1_form",$addnew,'class="btn btn-default active"')?>
              ...
              $formid="form".$list->id;
                     ...
                     <td width="150">
                         ...
                         <a href="javascript:makeedit('<?=$list->id?>','warehouse1')"><?=$edit?></a> 
                                                      
                          / 
	                   <a href="javascript:makedelete('<?=$list->id?>','warehouse1','<?=$this->uri->segment(4)?>')"><?=$delete?></a>
                        / 
            ...
            ?>
             <table class="table table-bordered table-hover table-striped tablesorter">
              ...
              <td> 
                ...
                <tr>
                 <td>Subwarehouse Name</td><td> 
                <?=form_dropdown('subwarehouse_id',$grab_tbl_id,'','class="form-control clonelastone"');?></td>
               </tr>
                 <tr>
                 <td>ကုဒ္နံပါတ္</td><td> 
