 ...
 <h1 > <small>Showroom Reject Entry Form</small></h1>

<?=form_open("",'class="cloneable-form" id="damage_showroom"');?>
        ...
        <th class="center"><?=$quantity?> (Pcs)</th>
                ...
                <tr class="clonethis">
                  ...
                  <tr>
                    ...
                    <td align="right" colspan="5"><?php echo form_button('save',$save,'class="btn btn-primary btn-lgy" onclick="insert_form(\'damage_showroom\')"');?></td>
                </tr> 
