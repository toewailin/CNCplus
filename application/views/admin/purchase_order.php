    ...
    <?=$from?> <input type="text" name="startdate" class="date form-control-sale" id="date1"/>
              ...
              <input type="button" class="btn btn-primary active" value="<?=$search?>" onclick="searchsingle('purchase_order_header')">
                  ...
                  <div class="col-lg-1 col-md-1 text-right">  
                         ...
                         -->
               <?=anchor("admin/insert_form/purchase_order_form",$addnew,'class="btn btn-default active"')?>
            ...
            if($list->status==0)
            {
              echo anchor("admin/viewdetails_deliver/pdeliver/".$list->voucherno,"Change To Bill","class='btn btn-primary'");
            }
            else
            {}
            ?>
