     <div class="panel panel-primary">
              <div class="panel-heading heading-over">
               ...
               <div class="container">
                    ...
                    <div class="col-md-3">
                  <h3 class="panel-title"><i class="fa fa-bars"></i> Main Warehouse Reject Lists</h3>
                  </div>

                  <div class="col-md-8">
                     <form name="singlesearch" id="damage_warehouse1">
               ...
               Value <input type="text" name="search" class="form-control-sale" onkeyup="searchsingle('damage_warehouse1')"/>
          
              <input type="button" class="btn btn-primary active" value="<?=$search?>" onclick="searchsingle('damage_warehouse1')">
            ...
            <div class="col-md-1 text-right"> 
                  ...
                  <?=anchor("admin/insert_form/damage_warehouse1_form",$addnew,'class="btn btn-default active"')?>
