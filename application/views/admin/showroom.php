            ...
            <div class="panel panel-primary">
              <div class="panel-heading heading-over">
               <div class="container">
                  ...
                  <div class="col-lg-2 col-md-2">
                    <h3 class="panel-title"><i class="fa fa-bars"></i> Showroom Lists</h3>
                  </div>

                  <div class="col-lg-9 col-md-9">
                      <form name="getreport" id="showroom">
             <?=$from?> <input type="text" name="startdate" class="form-control-sale date" id="date1"/>
              ...
              Value <input type="text" name="search" class="form-control-sale" onkeyup="searchsingle('showroom')"/>
              
              <input type="button" class="btn btn-primary active" value="<?=$search?>" onclick="searchsingle('showroom')">
            </form> 
                  </div>
                ...
                <div class="col-lg-1 col-md-1 text-right">  
                   ...
                   <a href="javascript:show_form('showroom_form')" class="btn btn-default active"><?=$addnew?></a> 
