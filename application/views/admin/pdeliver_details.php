...
<table class="table">
 ...
 <tr>
  <td colspan="2" align="right">  Advance<!-- ယခင္က်န္ေငြ (-) / ပိုေငြ / ၾကိဳေပးေငြ --></td><td width="200"> <input type="text" name="advance" id="advance" value="<?=$show->total_debt?>"  class="form-control-discount form-control"  onkeyup="payadvance(this.value,document.getElementById('total').value)"/></td>
 <td colspan="3" align="right"> </tr>
 <tr>
...
<tr>
 <tr>
       <td colspan="2" align="right">Pay Amount</td><td width="200"> <input type="text" name="pay" id="pay" value=""  class="form-control-discount form-control"/></td>
 <td colspan="3" align="right"> </tr>
<tr>
 <tr>
       <td colspan="2" align="right">Current Balance To Supplier</td><td width="200"> <input type="text" name="current_balance" id="current_balance" value=""  class="form-control-discount form-control"/></td>
 <td colspan="3" align="right"> </tr>
<tr>
